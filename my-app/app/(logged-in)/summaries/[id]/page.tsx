...
export default async function SummaryPage(props: {
    ...
    const readingtime=Math.ceil((summary.word_count || 0 ) / 200).toString();
    return (<div className="relative isolate min-h-screen bg-linear-to-b
         from-rose-50/40  to-white">
            ...
            <div className="container mx-auto flex flex-col gap-4">
               ...
               <h1 className="text-2xl lg:text-4xl font-bold
                lg:tracking-tight">
                    <span className="bg-linear-to-r from-rose-600
