        ...
        <section className="min-h-screen">
          ...
          <div className="mx-auto max-w-7xl px-6 py-24
           ...
           <div className="flex flex-col items-center
            ...
            overflow-hidden rounded-full bg-linear-to-r
                    from-rose-200 via-rose-500 to-rose-800
            ...
            <Badge
                ...
                <p className="text-base bg-linear-to-r
                        from-rose-800 via-rose-500 to-rose-800
                         bg-clip-text text-transparent">
                            AI-Powered Content Creation</p>
            </Badge>
            </div>
            <div className="capitalize text-3xl font-bold tracking-tight 
                ...
                <p>Upload your PDF and let our AI do the
                magic! ✨</p></div>
            </div>
            </div>
